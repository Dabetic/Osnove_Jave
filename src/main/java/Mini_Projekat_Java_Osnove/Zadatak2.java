...
public class Zadatak2 {
    public static void main(String[] args) {
        ...
        korisnici.add("Milos Milosevic");
        korisnici.add("Nikola Nikolic");
        korisnici.add("Aleksandra Aleksandrovic");
        korisnici.add("Marko Markovic");
        korisnici.add("Stefan Stefanovic");
        korisnici.add("Filip Filipovic");
        ...
        for (int j = 0; j < korisnici.size() ; j++) {
            ...
            if (!status.get(j)) {
                System.out.println("| slika |x " + korisnici.get(j));
            }
