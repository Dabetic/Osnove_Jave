...
public class Zadatak2 {
    public static void main(String[] args) {
        ...
        FacebookPost facebookPost1 = new FacebookPost(korisnik1);

        korisnik1.setIme("Milos");
        korisnik1.setPrezime("Dabetic");

        facebookPost1.setOpis("Kako lep i suncan dan!");
        facebookPost1.stampanje();
    }
}
